...
<div class="container">
	...
	<div id="pageBody">
		<div class="row">
			...
			<form action="<%=request.getContextPath() %>/sinh-vien/ket-qua-danh-gia?id=<%=danhGia.getMaDotDanhGia() %>" method="post">	
			
			<div id="sinhVienDanhGia">
			<div class="row" style="color: #3C763D">
				<h4 style="text-align: left">Đợt đánh giá: ${dotDanhGia.getTen() }</h4>
				<p><strong>Sinh viên: ${sinhVienDG.getTen() }, Lớp: ${lop.getTen() } </strong></p>
			</div>
