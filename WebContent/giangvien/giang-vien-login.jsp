...
<link
	href="<%=request.getContextPath()%>/templates/giangvien/css/style.css"
		...
		<div class="container-fluid">
			...
			<div>
				<ul class="nav navbar-nav">
					<li><a href="<%=request.getContextPath()%>/giang-vien">Lịch đánh giá</a></li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li><a href="<%=request.getContextPath()%>/giang-vien"><span class="glyphicon glyphicon-log-in"></span>
							Login</a></li>
				</ul>
			</div>
		</div>
			...
			<div id="login">
				...
				<div class="col-md-4">
					...
					<form id="registration-form" method="POST" class="form-horizontal"
						action="<%=request.getContextPath() %>/giang-vien">
