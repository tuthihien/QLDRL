	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<div class="list-group">
				...
				<a href="<%=request.getContextPath()%>/sinh-vien/tap-the-lop/danh-sach" class="list-group-item"> <span
					class="glyphicon glyphicon-wrench"></span> Lớp trưởng đánh giá
				</a> 
				<a href="<%=request.getContextPath()%>/sinh-vien/tap-the-lop/du-lieu" class="list-group-item"> <span
					class="glyphicon glyphicon-wrench"></span> Dữ liệu
				</a> 
