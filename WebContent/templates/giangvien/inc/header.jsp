    			...
    			<div class="navbar-header">
	   			...
	   			<div>
		      		<ul class="nav navbar-nav">
		       			<li><a href="<%=request.getContextPath()%>/giang-vien/gvcn/danh-sach-xac-nhan">Xác nhận DRL</a></li>
		       			<li><a href="<%=request.getContextPath()%>/giang-vien/gvcn/du-lieu">Dữ liệu</a></li>
		      		</ul>
