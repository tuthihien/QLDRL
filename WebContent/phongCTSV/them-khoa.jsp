...
<div class="container">
	...
	<div id="pageBody">
		<div class="row">
			...
			<form class="form-horizontal" role="form" method="post" action="<%=request.getContextPath()%>/phong-ctsv/them-khoa">
						  <div class="form-group">
						    <label class="control-label col-sm-4" for="name">Tên Khoa</label>
						    <div class="col-sm-6">
						      <input type="text" class="form-control" id="name" name="tenKhoa" value="">
						    </div>
