...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
				<%	
					...
					if (giangVien!= null && dotDanhGia != null ) {
				%>
				...
				<div id="sinhVienDanhGia">
					...
					<form class="form-horizontal" role="form" method="post" action="">
						  <div class="form-group">
						    ...
						    <div class="col-sm-6">
						      <input type="text" class="form-control" id="name" name="ten" value="<%=dotDanhGia.getTen()%>">
						    </div>
						  </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6">
						    	<div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy hh:ii:ss" data-link-field="dtp_input2" data-link-format="dd/mm/yyyy hh:ii:ss">
			            			<input class="form-control" type="datetime"  value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayBatDauSV()) %>" readonly>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									<input type="hidden" id="dtp_input2" name="ngaybdsv" value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayBatDauSV()) %>" />
			            		</div>
						  	</div>
						  </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6"> 
						     	<div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy hh:ii" data-link-field="dtp_input2" data-link-format="dd/mm/yyyy hh:ii">
			            			<input class="form-control" type="datetime"  value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayKetThucSV()) %>" readonly>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									<input type="hidden" id="dtp_input2" name="ngayktsv" value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayKetThucSV()) %>" />
			            		</div>
						    </div>
						  </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6"> 
								<div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy hh:ii:ss" data-link-field="dtp_input2" data-link-format="dd/mm/yyyy hh:ii:ss">
			            			<input class="form-control" type="datetime"  value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayBatDauLT()) %>" readonly>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									<input type="hidden" id="dtp_input2" name="ngaybdttl" value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayBatDauLT()) %>" />
			            		</div>						    
			            	</div>
						  </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6"> 
						      <div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy hh:ii:ss" data-link-field="dtp_input2" data-link-format="dd/mm/yyyy hh:ii:ss">
			            			<input class="form-control" type="datetime"  value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayKetThucLT()) %>" readonly>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									<input type="hidden" id="dtp_input2" name="ngayktttl" value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayKetThucLT()) %>" />
			            		</div>
						    </div>
						  </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6"> 
						    <div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy hh:ii:ss" data-link-field="dtp_input2" data-link-format="dd/mm/yyyy hh:ii:ss">
						     		 <input class="form-control" type="datetime"  value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayBatDauGV()) %>" readonly>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									<input type="hidden" id="dtp_input2" name="ngaybdgv" value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayBatDauGV()) %>" />
						    </div>
						  </div>
						  </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6">
						    <div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy hh:ii:ss" data-link-field="dtp_input2" data-link-format="dd/mm/yyyy hh:ii:ss"> 
						      <input class="form-control" type="datetime"  value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayKetThucGV()) %>" readonly>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									<input type="hidden" id="dtp_input2" name="ngayktgv" value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayKetThucGV()) %>" />
						    </div>
						  </div>
						  </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6"> 
						    <div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy hh:ii:ss" data-link-field="dtp_input2" data-link-format="dd/mm/yyyy hh:ii:ss">
						      <input class="form-control" type="datetime"  value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayBatDauTK()) %>" readonly>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									<input type="hidden" id="dtp_input2" name="ngaybdtk" value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayBatDauTK()) %>" />
						    </div>
						  </div>
						  </div>
						  <div class="form-group">
						    ...
						    <div class="col-sm-6"> 
						    <div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy hh:ii:ss" data-link-field="dtp_input2" data-link-format="dd/mm/yyyy hh:ii:ss">
						      <input class="form-control" type="datetime"  value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayKetThucTK()) %>" readonly>
									<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
									<input type="hidden" id="dtp_input2" name="ngaykttk" value="<%=DateUtils.formatDatetime(dotDanhGia.getNgayKetThucTK()) %>" />
						    </div>
						  </div>	
						 </div>
						  <div class="form-group"> 
						    <div class="col-sm-offset-2 col-sm-10">
						      <button type="submit" class="btn btn-success" name="action" value="tao">Cập nhật</button>
						    </div>
						  </div>
					</form>
			</div>
