 ...
 */
public class PhongCTSVDanhSachSinhVien extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PhongCTSVDanhSachSinhVien() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (idKhoa != null) {
			if (idLop != null && Integer.parseInt(idLop) > 0) {
				...
				ArrayList<SinhVien> listSinhVienByLop = sinhVienBO.getAllSinhViebByLop(idLop);
				request.setAttribute("listSinhVienByLop", listSinhVienByLop);
				RequestDispatcher rd = request.getRequestDispatcher("/phongCTSV/phong-CTSV-danhsach-sinhvien.jsp");
