...
/**
 * Servlet implementation class TruongKhoaDuLieuDanhGiaServlet
 */

public class TruongKhoaDuLieuDanhGiaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TruongKhoaDuLieuDanhGiaServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//lay danh sach cac lop thuoc khoa
		listLop = lopBO.getAllLopByKhoa(giangVien.getMaKhoa());
		System.out.println(giangVien.getMaKhoa());
	    ...
	    RequestDispatcher rd = request.getRequestDispatcher("/giangvien/truong-khoa-du-lieu-danh-gia.jsp");
