...
/**
 * Servlet implementation class GiangVienXemChiTietDanhGiaServlet
 */

public class GiangVienXemChiTietDanhGiaServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GiangVienXemChiTietDanhGiaServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/giangvien/xem-chi-tiet-danh-gia.jsp");
