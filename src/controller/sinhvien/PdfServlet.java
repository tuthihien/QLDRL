	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// step 1
	    		...
	    		cell = new PdfPCell(new Phrase("DANH SÁCH ĐIỂM RÈN LUYỆN LỚP " + lopBO.getLopTheoMa(sinhVien.getMaLop()).getTen(), f12b));
	    		cell.setHorizontalAlignment(Rectangle.ALIGN_CENTER);
	    		cell.setBorder(Rectangle.NO_BORDER);
	    		cell.setColspan(2);
...
//	    		cell.setHorizontalAlignment(Rectangle.RIGHT);
	    		...
	    		cell = new PdfPCell(new Phrase("              Lớp trưởng", f10b));
//	    		cell.setHorizontalAlignment(Rectangle.RIGHT);
	    		cell.setBorder(Rectangle.NO_BORDER);
	    		cell.setColspan(6);
	    		cell.setPaddingBottom(40);
